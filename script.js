...
const hideAllTabBodu=()=> allTabsBody.forEach(singleTabBody =>singleTabBody.classList.remove('show-tab'));
...
const fetchAllSuperHero=async (searchText)=>{
    let url=`https://www.superheroapi.com/api.php/360082589671631/search/${searchText}`;
    try {
...
searchForm.search.addEventListener('keyup',()=>{
    if(searchForm.search.value.length){
...
<li>
    ...
    <span>${data[0].connections['group-affiliation']}
    </span>
</li>
<li>
    <span>relatives</span>
